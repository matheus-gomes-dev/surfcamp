...
const Header = ({ dictionary, lang }: HeaderProps) => {
  ...
  const menuItems = [
    ...
    { label: dictionary.explore, href: `/${lang}/explore`, isContact: false },
              ...
              {menuItems.map((item) => (
                item.isContact ? (
                  <button
                    ...
                    className="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 cursor-pointer"
                  >
                    {item.label}
                  </button>
                ) : (
              ...
              {menuItems.map((item) => (
                item.isContact ? (
                  <button
                    ...
                    className="text-gray-600 hover:text-gray-900 block px-3 py-2 rounded-md text-base font-medium transition-colors duration-200 w-full text-left"
                  >
                    {item.label}
                  </button>
                ) : (
